...
public class DxfViewportTest {
    ...
    public static void main(String[] args){
        ...
        DxfViewport.View paper=DxfViewport.parse(tags(40,10,41,10,68,1,69,1,45,10,36,1),0,14);if(paper.active2d())throw new AssertionError("paper viewport id 1 must not show model");
        DxfViewport.View off=DxfViewport.parse(tags(40,10,41,10,68,1,69,2,45,10,36,1,90,DxfViewport.FLAG_OFF),0,16);if(off.active2d())throw new AssertionError("off viewport");
        DxfViewport.View perspective=DxfViewport.parse(tags(40,10,41,10,68,1,69,2,45,10,36,1,90,DxfViewport.FLAG_PERSPECTIVE),0,16);if(perspective.active2d())throw new AssertionError("perspective viewport");
        DxfViewport.View clipped=DxfViewport.parse(tags(40,10,41,10,68,1,69,2,45,10,36,1,90,DxfViewport.FLAG_NON_RECTANGULAR),0,16);if(!clipped.active2d()||clipped.rectangular())throw new AssertionError("nonrect flag");
