...
public final class DxfColor {
    ...
    /**
     * Exact 256-entry rgb_palette from MusaCAD's pinned LibreDWG revision
     * 34f02f54b9aacb5708c1d3d2070efb3e4b2d8c43.
     * Index 0 is retained for parity, although ACI 0 means BYBLOCK to DXF callers.
     */
    ...
    /** Returns an opaque ARGB color for ACI 1..255 using the pinned LibreDWG palette. */
    public static int aciArgb(int aci){return 0xFF000000|aciRgb(aci);}

    /** Returns 0xRRGGBB for ACI 1..255; invalid/BYBLOCK/BYLAYER input falls back to ACI 7. */
