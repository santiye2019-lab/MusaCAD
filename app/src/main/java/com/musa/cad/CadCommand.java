...
public final class CadCommand {
    public enum Action {
        ...
        PAN, MOVE, COPY, ROTATE, ERASE, SCALE, MIRROR, OFFSET, ARRAY, EXPLODE, OSNAP, REGEN, TRIM, EXTEND, FILLET, CHAMFER, BREAK, PEDIT, LIST, MATCHPROP, JOIN, HATCH, STRETCH, BLOCK, INSERT, LAYER, PROPERTIES,
    ...
    public static String canonical(String raw){
        ...
        switch(a){
            ...
            case TRIM:return "TRIM";case EXTEND:return "EXTEND";case FILLET:return "FILLET";case CHAMFER:return "CHAMFER";case BREAK:return "BREAK";case PEDIT:return "PEDIT";case LIST:return "LIST";case MATCHPROP:return "MATCHPROP";case JOIN:return "JOIN";case HATCH:return "HATCH";case STRETCH:return "STRETCH";case BLOCK:return "BLOCK";case INSERT:return "INSERT";
