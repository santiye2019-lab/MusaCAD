...
public final class DxfParser {
    ...
    public static final class Result{
        ...
        public Result withVisibleLayers(Set<String>selected)throws IOException{Set<String>visible=new HashSet<>(selected);visible.retainAll(layerNames);Result r=renderLayout(document,layerNames,visible,layoutNames,activeLayout,skippedCount,millimetersPerUnit,drawingUnitName,globalLineTypeScale,lineTypes,layerColors,layerLineTypes,layerLineWeights);r.conversionWarnings=conversionWarnings;return r;}
        public Result withLayout(String selected)throws IOException{String layout=findLayout(layoutNames,selected);Result r=renderLayout(document,layerNames,visibleLayers,layoutNames,layout,skippedCount,millimetersPerUnit,drawingUnitName,globalLineTypeScale,lineTypes,layerColors,layerLineTypes,layerLineWeights);r.conversionWarnings=conversionWarnings;return r;}
    ...
    private static Result renderStreaming(File file)throws IOException{
        ...
        return renderLayout(entities,layers,layers,layouts,initial,expanded.skipped,mm,unitName,expanded.globalLineTypeScale,expanded.lineTypes,expanded.layerColors,expanded.layerLineTypes,expanded.layerLineWeights);
    }
    ...
    private static Result renderLayout(List<Entity>document,Set<String>all,Set<String>visible,Set<String>layouts,String requested,int skipped,double mm,String unitName,double global,Map<String,DxfLineStyle.Pattern>lineTypes,Map<String,Integer>layerColors,Map<String,String>layerLineTypes,Map<String,Integer>layerLineWeights)throws IOException{
