...
public final class DxfParser {
    ...
    public static final class Result{
        ...
        public int layerColor(String name){
            String wanted=name==null?"0":name;for(Entity entity:document){LayerEntity layer=(LayerEntity)entity;if(layer.layer.equalsIgnoreCase(wanted))return layer.color;}return Color.WHITE;
        }
        public int layerLineWeight(String name){
            String wanted=name==null?"0":name;for(Entity entity:document){LayerEntity layer=(LayerEntity)entity;if(layer.layer.equalsIgnoreCase(wanted))return layer.lineWeight;}return DxfLineStyle.DEFAULT_LINEWEIGHT;
        }
        public String layerLineType(String name){
            String wanted=name==null?"0":name;for(Entity entity:document){LayerEntity layer=(LayerEntity)entity;if(layer.layer.equalsIgnoreCase(wanted))return layer.lineType;}return DxfLineStyle.CONTINUOUS;
        }
